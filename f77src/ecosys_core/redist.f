...
C     ENDIF
C      write(444,*)I*100+J,UVOLO(N2,N1),WO,'wo',N,N6,N5,N4
C
...
C      if(IYRC<=1981)THEN
C      write(118,*)I+J/24.,VOLW(0,NY,NX),FLWR(NY,NX),THAWR(NY,NX)
C     2,TQR(NY,NX),PRECA(NY,NX),CVRD(NY,NX)
C      ENDIF
...
C
C      if(IYRC<=1981)then
C      write(117,*)I+J/24.,VOLW(0,NY,NX)
C      endif
...
C     ENDIF
C      IF(IYRC==1990)THEN
C      WRITE(113,*)I+J/24.,SUM(OQC(0:2,0,NY,NX)),TKS(0,NY,NX)-273.15
C     2,ARLFC(NY,NX)/AREA(3,NU(NY,NX),NY,NX),RCO2O(0,NY,NX)
C     3,ORGC(0,NY,NX),sum(OMC(1:3,1,0:2,0,NY,NX))
C     4,sum(OMC(1:3,3,0:2,0,NY,NX))
C      ELSEIF(IYRC==1980)THEN
C      WRITE(114,*)I+J/24.,SUM(OQC(0:2,0,NY,NX)),TKS(0,NY,NX)-273.15
C     2,ARLFC(NY,NX)/AREA(3,NU(NY,NX),NY,NX),RCO2O(0,NY,NX)
C     3,ORGC(0,NY,NX),sum(OMC(1:3,1,0:2,0,NY,NX))
C     4,sum(OMC(1:3,3,0:2,0,NY,NX))
C      ENDIF
